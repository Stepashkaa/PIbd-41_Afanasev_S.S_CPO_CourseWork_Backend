...
@Schema(description = "Запрос на создание вылета тура (TourDeparture)")
public record TourDepartureCreateRequest(
        ...
        @Schema(description = "Начальное количество забронированных мест", example = "0")
